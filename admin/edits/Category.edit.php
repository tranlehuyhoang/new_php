...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_GET['catid'])) {
    $updatecat = $cat->update_category($_POST, $_GET['catid']);
}
?>
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <div class="mb-3"> <label for="form-text" class="form-label fs-14 text-dark">Nhập tên danh
                                ...
                                ?>
                                    <input name="categoryname" value="<?php echo $result['categoryname'] ?>" type="text" class="form-control" id="form-text" placeholder="">
                                <?php
                                } ?>
                            </div>
