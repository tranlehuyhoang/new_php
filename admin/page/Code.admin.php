 <?php
    ...
    $class = new code();
    $show = $class->show_code();


    if (isset($_GET['delid'])) {
        $delid = $_GET['delid'];
        $delete = $class->delete_code($delid);
        $show = $class->show_code();
    }
    ?>
             ...
             <div class="ms-md-1 ms-0">
                 <nav>
                     <ol class="breadcrumb mb-0">
                         ...
                         <li class="breadcrumb-item active" aria-current="page">Code Tables</li>
                     </ol>
                 </nav>
             </div>
             ...
             <div class="col-xl-12">
                 <div class="card custom-card">
                     <div class="card-header">
                         <div class="card-title"> Code Datatable
                             <a href="../creates/Code.create.php"><button type="button" class="btn btn-info">Create
                                     +</button></a>
                         </div>
                     </div>
                     <div class="card-body">
                         <table id="example" class="table table-striped" style="width:100%">
                             ...
                             <tbody>
                                 <?php
                                    ...
                                    ?>
                                             <tr>
                                                 <td><?php echo $result['codeid'] ?> </td>
                                                 <td><?php echo $result['codename'] ?> </td>
                                                 <td><?php echo $result['codepercent'] ?> </td>
                                                 <td><?php echo $result['codedate'] ?></td>
                                                 <td>
                                                     <div class="d-flex gap-2">
                                                         <div class="edit">
                                                             <a href="../edits/Code.edit.php?editid=<?php echo $result['codeid']; ?>">
                                                                 <button class="btn btn-sm btn-success edit-item-btn" data-bs-toggle="modal" data-bs-target="#showModal">Edit</button>
                                                             </a>
                                                         </div>
                                                         <div class="remove">
                                                             <a onclick="return confirm('Xác nhận xóa')" href="?delid=<?php echo $result['codeid']; ?>">
