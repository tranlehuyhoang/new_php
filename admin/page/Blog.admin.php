 <?php
    ...
    if (isset($_GET['delid'])) {
        $delid = $_GET['delid'];
        $delete = $class->delete_blog($delid);
        $show = $class->show_blog();
    }
    ?>
         ...
         <div class="row">
                 ...
                 <div class="card custom-card">
                     <div class="card-body d-flex align-items-center justify-content-between">
                         <div class="fs-15 mb-0">Total <span class="badge bg-success">12</span> products are wishlisted
                             <a href="../creates/Blog.create.php"><button type="button" class="btn btn-info">Create
                                     +</button></a>
                         </div>
             ...
             <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                 <div class="card custom-card product-card">
                     <div class="card-body"> <a href="javascript:void(0)" class="product-image">
                         ...
                         <span class="float-end text-warning fs-12"><?php echo  $result['blogdate']; ?></span>
                         <p class="mb-1 fw-semibold fs-16 d-flex align-items-center justify-content-between">
                             <span> <?php echo  $result['blogtitle']; ?>
                             </span>
                         </p>

                         <p class="product-name fw-semibold mb-0 d-flex align-items-center justify-content-between">
                             <?php echo  $result['blogheader']; ?> </p>
                         <p class="product-description fs-11 text-muted mb-2"> <?php echo  $result['blogdesc']; ?></p>
                         <p class="fs-11 text-success fw-semibold mb-0 d-flex align-items-center"> <i
                                 class="ti ti-discount-2 fs-16 me-1"></i><?php
                                                                                                                                                            switch ($result['blogtagid']) {
                                                                                                                                                                case  1:
                                                                                                                                                                    echo '#SảnPhẩm</';
                                                                                                                                                                    break;
                                                                                                                                                                case  2:
                     ...
                     <div class="card-footer text-center"> <a onclick="return confirm('Xác nhận xóa')"
                             href="?delid=<?php echo $result['blogid']; ?>" class="btn btn-primary-light m-1"> Delete
                             Blog</a>
                         <a href="../edits/Blog.edit.php?editid=<?php echo $result['blogid']; ?>"
                             class="btn btn-success-light m-1">Update Product</a>
                     </div>
                 </div>
             </div>
             <?php
