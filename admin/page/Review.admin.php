  ...
  <div class="main-content app-content">
      <div class="container-fluid">
          ...
          <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 class="page-title fw-semibold fs-18 mb-0">Reviews <a href="../creates/review.create.php"><button
                          type="button" class="btn btn-info">Create
                          +</button></a></h1>
                                      ...
                                      <div class="d-flex align-items-center justify-content-between">
                                          <div class="d-flex align-items-center"> <span class="text-muted">Rating :
                                                  ...
                                                  <svg xmlns="http://www.w3.org/2000/svg"
                                                      xmlns:xlink="http://www.w3.org/1999/xlink" height="10px"
                                                      width="10px" version="1.1" id="Capa_1" viewBox="0 0 47.94 47.94"
                                                      xml:space="preserve">
                                          ...
                                          <div class="float-end fs-12 fw-semibold text-muted text-end">
                                              <span><?php echo $result['reviewdate']; ?></span> <span
                                                  class="d-block fw-normal fs-12 text-success"><i> <a
                                                          href="../edits/Review.edit.php?editid=<?php echo $result['reviewid']; ?>">
                                                          <button class="btn btn-sm btn-success edit-item-btn"
                                                              data-bs-toggle="modal"
                                                              data-bs-target="#showModal">Edit</button>
                                                      </a>
                                                      <a onclick="return confirm('Xác nhận xóa')"
                                                          href="?delid=<?php echo $result['reviewid']; ?>">
