...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $insertCat = $pd->insert_product($_POST);
}
?>
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <div class="mb-3"> <label for="form-text" class="form-label fs-14 text-dark">Nhập tên sản
                                    phẩm
                                </label> <input name="productname" type="text" class="form-control" id="form-text" placeholder="">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3"> <label for="form-text" class="form-label fs-14 text-dark">Nhập giá
                                </label> <input name="productprice" type="number" class="form-control" id="form-text" placeholder="">
                            </div>
                            <div class="mb-3"> <label for="form-text" class="form-label fs-14 text-dark">Nhập sale
                                </label> <input name="productsale" type="number" class="form-control" id="form-text" placeholder="">
                            </div>
                            <div class="mb-3"> <label for="form-text" class="form-label fs-14 text-dark">Nhập tồn kho
                                    mục
                                </label> <input name="productstock" type="number" class="form-control" id="form-text" placeholder="">
                            </div>
                            ...
                            <div class="mb-3"> <label for="form-text" class="form-label fs-14 text-dark">Nhập số lượng
                                    đã bán
                                </label> <input name="productquantitysell" type="number" class="form-control" id="form-text" placeholder="">
                            </div>
