...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $codeinsert = $code->insert_blog($_POST);
}
?>
                ...
                <div class="col-xl-6">
                    <div class="card custom-card">
                        <div class="card-header justify-content-between">
                            <div class="card-title"> Create Blog Form </div>
                            <?php
                            if (isset($codeinsert)) {
                                echo $codeinsert;
                            }
                        ...
                        <div class="card-body">
                            <div class="mb-3"> <label for="form-text" class="form-label fs-14 text-dark">Nhập tiêu đề
                                </label> <input name="blogtitle" type="text" class="form-control" id="form-text"
                                    placeholder="">
                            </div>
                            <div class="mb-3"> <label for="form-text" class="form-label fs-14 text-dark">Nhập header
                                </label> <input name="blogheader" type="text" class="form-control" id="form-text"
                                    placeholder="">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="blogtagid" id="selectform" multiple=""
                                    aria-label="multiple select example">

                                    <option selected value="1"> #SảnPhẩm</option>
                                    <option value="2">#KhuyếnMãi</option>
                                    <option value="3">#MuaSắmOnline</option>
                                    <option value="4">#ThanhToán</option>
                                    <option value="5">#ĐánhGiá</option>
