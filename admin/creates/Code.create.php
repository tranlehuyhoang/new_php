...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $codeinsert = $code->insert_code($_POST);
}
?>
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <div class="mb-3"> <label for="form-text" class="form-label fs-14 text-dark">Nhập mã giảm
                                    giá
                                </label> <input name="codename" type="text" class="form-control" id="form-text"
                                    placeholder="">
                            </div>
                            <div class="mb-3"> <label for="form-text" class="form-label fs-14 text-dark">Nhập %
                                </label>
                                <select name="codepercent" class="form-select" id="selectform" multiple=""
