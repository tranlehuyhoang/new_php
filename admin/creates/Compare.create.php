...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $codeinsert = $code->insert_compare($_POST);
}
?>
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <div class="mb-3"> <label for="form-text" class="form-label fs-14 text-dark">Nhập id user
                                </label> <select name="compareuserid" class="form-select" id="selectform" multiple="" aria-label="multiple select example">
                                    <?php
                                    if (isset($show)) {
                            ...
                            <div class="mb-3"> <label for="form-text" class="form-label fs-14 text-dark">Nhập id product
                                </label> <select name="compareproductid" class="form-select" id="selectform" multiple="" aria-label="multiple select example">
                                    <?php
                                    if (isset($shows)) {
