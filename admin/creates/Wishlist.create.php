...
$pd = new product();
$showpd = $pd->show_product();
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $codeinsert = $code->insert_wishlist($_POST);
    $show = $class->show_user();
    $showpd = $pd->show_product();
}
?>
            ...
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="catlist.php">Wishlist</a></li>
                ...
                <div class="col-xl-6">
                    <div class="card custom-card">
                        <div class="card-header justify-content-between">
                            <div class="card-title"> Create Wishlist Form </div>
                            <?php
                            if (isset($codeinsert)) {
                                echo $codeinsert;
                            }
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="wishlistuserid" id="selectform" multiple="" aria-label="multiple select example">
                                    <?php
                                    if (isset($show)) {
                                        if ($show && $show->num_rows > 0) {
                                            ...
                                            while ($result = $show->fetch_assoc()) {
                                                # code...
                                    ?>
                                                <option value="<?php echo  $result['userid']; ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="wishlistproductid" class="form-select" id="selectform" multiple="" aria-label="multiple select example">

                                    <?php
                                    if (isset($show)) {
                                        if ($show && $show->num_rows > 0) {
                                            $i = 0;
                                            while ($result = $showpd->fetch_assoc()) {
                                                # code...
                                    ?>
