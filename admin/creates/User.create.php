...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $codeinsert = $code->insert_user($_POST);
}
?>
                ...
                <div class="col-xl-6">
                    <div class="card custom-card">
                        <div class="card-header justify-content-between">
                            <div class="card-title"> Create User Form </div>
                            <?php
                            if (isset($codeinsert)) {
                                echo $codeinsert;
                            }
                        ...
                        <div class="card-body">
                            <div class="mb-3"> <label for="form-text" class="form-label fs-14 text-dark">Nhập tên user
                                </label> <input name="username" type="text" class="form-control" id="form-text"
                                    placeholder="">
                            </div>
                            <div class="mb-3"> <label for="form-text" class="form-label fs-14 text-dark">Nhập email user
                                </label> <input name="useremail" type="email" class="form-control" id="form-text"
                                    placeholder="">
                            </div>
                            <div class="mb-3"> <label for="form-text" class="form-label fs-14 text-dark">Nhập pass user
                                </label> <input name="userpass" type="password" class="form-control" id="form-text"
                                    placeholder="">
                            </div>
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="selectform" name="userroles"
