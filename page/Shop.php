                ...
                <div class="col-lg-9 order-lg-2 mb-md--30">
                    ...
                    <div class="shop-product-wrap grid gridview-3 row no-gutters">
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                            <div class="mirora-product mb-md--10">
                                <div class="product-img">
                                    ...
                                    <img src="http://localhost/asm/assets/img/products/1-1-450x450.jpg" alt="Product" class="secondary-image" />
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                            <div class="mirora-product mb-md--10">
                                <div class="product-img">
                                    <img src="http://localhost/asm/assets/img/products/2-450x450.jpg" alt="Product" class="primary-image" />
                                    <img src="http://localhost/asm/assets/img/products/2-2-450x450.jpg" alt="Product" class="secondary-image" />
                                    <div class="product-img-overlay">
                                        <span class="product-label discount">
                                            -7%
                                        </span>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                            <div class="mirora-product mb-md--10">
                                <div class="product-img">
                                    <img src="http://localhost/asm/assets/img/products/3-450x450.jpg" alt="Product" class="primary-image" />
                                    <img src="http://localhost/asm/assets/img/products/3-3-450x450.jpg" alt="Product" class="secondary-image" />
                                    <div class="product-img-overlay">
                                        <span class="product-label discount">
                                            -7%
                                        </span>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                            <div class="mirora-product mb-md--10">
                                <div class="product-img">
                                    <img src="http://localhost/asm/assets/img/products/4-450x450.jpg" alt="Product" class="primary-image" />
                                    <img src="http://localhost/asm/assets/img/products/4-4-450x450.jpg" alt="Product" class="secondary-image" />
                                    <div class="product-img-overlay">
                                        <span class="product-label discount">
                                            -7%
                                        </span>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                            <div class="mirora-product mb-md--10">
                                <div class="product-img">
                                    <img src="http://localhost/asm/assets/img/products/5-450x450.jpg" alt="Product" class="primary-image" />
                                    <img src="http://localhost/asm/assets/img/products/5-5-450x450.jpg" alt="Product" class="secondary-image" />
                                    <div class="product-img-overlay">
                                        <span class="product-label discount">
                                            -7%
                                        </span>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                            <div class="mirora-product mb-md--10">
                                <div class="product-img">
                                    <img src="http://localhost/asm/assets/img/products/6-450x450.jpg" alt="Product" class="primary-image" />
                                    <img src="http://localhost/asm/assets/img/products/6-6-450x450.jpg" alt="Product" class="secondary-image" />
                                    <div class="product-img-overlay">
                                        <span class="product-label discount">
                                            -7%
                                        </span>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                            <div class="mirora-product mb-md--10">
                                <div class="product-img">
                                    <img src="http://localhost/asm/assets/img/products/7-450x450.jpg" alt="Product" class="primary-image" />
                                    <img src="http://localhost/asm/assets/img/products/7-7-450x450.jpg" alt="Product" class="secondary-image" />
                                    <div class="product-img-overlay">
                                        <span class="product-label discount">
                                            -7%
                                        </span>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                            <div class="mirora-product mb-md--10">
                                <div class="product-img">
                                    <img src="http://localhost/asm/assets/img/products/8-450x450.jpg" alt="Product" class="primary-image" />
                                    <img src="http://localhost/asm/assets/img/products/8-8-450x450.jpg" alt="Product" class="secondary-image" />
                                    <div class="product-img-overlay">
                                        <span class="product-label discount">
                                            -7%
                                        </span>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                            <div class="mirora-product mb-md--10">
                                <div class="product-img">
                                    <img src="http://localhost/asm/assets/img/products/9-450x450.jpg" alt="Product" class="primary-image" />
                                    <img src="http://localhost/asm/assets/img/products/9-9-450x450.jpg" alt="Product" class="secondary-image" />
                                    <div class="product-img-overlay">
                                        <span class="product-label discount">
                                            -7%
                                        </span>
